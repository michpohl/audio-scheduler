...
If you connect a motion sensor (or whatever else you want that sends a triggering signal) it alters the playback frequency based on detected motions (more detections -> faster frequency)
